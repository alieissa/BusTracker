...
angular.module('busTrackerApp', ['firebase', 'ngAnimate', 'ngCookies', 'ngResource', 'routesMod', 'stopsMod', 'ngSanitize', 'ngTouch']).config(function ($routeProvider, $firebaseRefProvider) {
  $routeProvider.when('/', {
